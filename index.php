    ...
    <body>
        <div class="wrapper">
                            ...
                            <div class="row">
                                ...
                                <div class="col-4">
                                    <div class="top-bar-item">
                                        ...
                                        <div class="top-bar-text">
                                            <h3>Email Us</h3>
                                            <p>nurulhapsari1995@gmail.com</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div id="carousel" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="img/bg.jpg" alt="Carousel Image">
                        <div class="carousel-caption">
                            <p class="animated fadeInRight">Official Website Of</p>
                            <h1 class="animated fadeInLeft">Lembaga Kursus Mengemudi Mahir</h1>
                            <a class="btn animated fadeInUp" href="login/login.php">Daftar Sekarang</a>
                        </div>
                    </div>
                    ...
                    <div class="carousel-item">
                        <img src="img/bg.jpg" alt="Carousel Image">
                        <div class="carousel-caption">
                            <p class="animated fadeInRight">Professional Instructure</p>
                            <h1 class="animated fadeInLeft">We Always Ready</h1>
                            <a class="btn animated fadeInUp" href="#">Daftar Sekarang</a>
                        </div>
                    </div>
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption">
                            ...
                            <h1 class="animated fadeInLeft">For Your Safety On The Road</h1>
                            <a class="btn animated fadeInUp" href="#">Daftar Sekarang</a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-4 col-md-12">
                            <div class="feature-item">
                                ...
                                <div class="feature-text">
                                    <h3>Instruktur Bersertifikat</h3>
                                    <p>Kami akan membimbing anda secara professional</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-12">
                            <div class="feature-item">
                                ...
                                <div class="feature-text">
                                    <h3>Edukatif</h3>
                                    <p>Berkurikulum, Skill Mengemudi Halus, Aman dan Nyaman, Memahami Rabu-Rambu, Paham Etika dan Tata Cara di Jalan</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-12">
                            <div class="feature-item">
                                ...
                                <div class="feature-text">
                                    <h3>24/7 Support</h3>
                                    <p>Kami Siap Melayani Anda dan Memberikan Yang Terbaik</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="video wow fadeIn" data-wow-delay="0.1s">
                <div class="container">
                    <button type="button" class="btn-play" data-toggle="modal" data-src="img/mahir.mp4" data-target="#videoModal">
                        <span></span>
                    </button>
                </div>
            </div>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.2s">
                            <div class="team-item">
                                <div class="team-img">
                                    <img src="img/bapak3.jpeg" alt="Team Image">
                                </div>
                                <div class="team-text">
                                    <h2>Mahmud</h2>
                                    <p>CEO & Founder</p>
                        ...
                        <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                            <div class="team-item">
                                <div class="team-img">
                                    <img src="img/adien.jpg" alt="Team Image">
                                </div>
                                <div class="team-text">
                                    <h2>Nurul Hapsari Adenia</h2>
                                    <p>Web Developer</p>
                                </div>
                                <div class="team-social">
                                    <a class="social-tw" href=""><i class="fab fa-twitter"></i></a>
